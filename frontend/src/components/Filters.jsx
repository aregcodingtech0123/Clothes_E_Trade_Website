  ...
  return (
    <div className="relative min-w-[180px]">
      <select
        ...
        className="appearance-none bg-white border border-gray-300 rounded-md px-4 py-2 pr-8 w-full focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
      >
    ...
    <div className="mb-8 bg-gray-50 p-4 rounded-lg">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <button 
          ...
          className="px-4 py-2 bg-white border border-amber-500 text-amber-600 hover:bg-amber-50 rounded-md font-medium transition-colors"
        >
          Filtreleri Temizle
        </button>
      </div>
