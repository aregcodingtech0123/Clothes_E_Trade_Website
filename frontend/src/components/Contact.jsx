...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitStatus({ success: false, message: 'Mesaj gönderilirken bir hata oluştu. Lütfen tekrar deneyin.' });
    } finally {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-gray-700 mb-4">Bize Ulaşın</h2>
            ...
            {/* İletişim Bilgileri */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-gray-700 mb-4">İletişim Bilgileri</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">+90 555 123 45 67</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">info@tommarkalar.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Tom Markalar Plaza, No:123, İstanbul</p>
                  </div>
                </div>
                ...
                <div className="pt-4">
                  ...
                  <p className="text-sm text-gray-500">Cumartesi: 10:00 - 15:00</p>
