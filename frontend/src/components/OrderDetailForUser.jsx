...
import { Check, MapPin, CreditCard, User, Truck, X, ArrowLeft } from 'lucide-react';
    ...
    return (
      <>
        ...
        <div className="container mx-auto px-4 py-8 min-h-screen">
          <button 
            onClick={() => navigate(-1)}
            className="flex items-center text-amber-600 mb-4"
          >
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden mb-6">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-500">
              Şu zamanda sipariş edildi: {order.createdAt ? new Date(order.createdAt).toLocaleDateString('tr-TR', {
                year: 'numeric',
                month: 'long',
                day: 'numeric',
                hour: '2-digit',
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <address className="not-italic space-y-2">
              <p className="font-medium">{shippingAddress.fullName || 'Belirtilmedi'}</p>
              <p>{shippingAddress.street || shippingAddress.address || 'Address yok'}</p>
              <p>
                {shippingAddress.district || 'District not specified'}, {shippingAddress.city || 'City not specified'}
              </p>
            ...
            <div className="space-y-3">
              ...
              <p>
                <span className="font-medium">Sipariş Durumu:</span> {
                  ...
                  order.paymentStatus === 'failed' ? 'Yapılmadı' :
                  order.paymentStatus || 'Not specified'
                }
              </p>
              <p>
                <span className="font-medium">Toplam Ücret:</span> 
                <span className="text-amber-600 font-bold ml-1">{total.toFixed(2)} TL</span>
              </p>
            </div>
          </div>
