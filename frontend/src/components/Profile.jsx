...
import { FiEdit, FiSave, FiX, FiShoppingBag, FiUser, FiMail, FiLock } from 'react-icons/fi';
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (error.response?.status === 401) {
          ...
          toast.error(error.response?.data?.message || 'Kullanıcı bilgileri alınamadı');
        }
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            {isEditing ? (
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-700 mb-1 font-medium">Ad Soyad *</label>
                  <input
                    type="text"
                    name="name"
                    value={editData.name}
                ...
                <div>
                  <label className="block text-gray-700 mb-1 font-medium">E-posta *</label>
                  <input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-gray-700 mb-1 font-medium">Yeni Şifre</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="mt-1 text-lg text-gray-900">{user.name || 'Bilgi Yok'}</p>
                </div>
