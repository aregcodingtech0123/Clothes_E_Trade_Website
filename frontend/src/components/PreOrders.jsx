      ...
      <>
        ...
        <div className="container mx-auto px-4 py-8 min-h-screen">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">Henüz siparişiniz bulunmamaktadır</h3>
            <p className="mt-1 text-sm text-gray-500 mb-6">Alışverişe başlayarak ilk siparişinizi oluşturabilirsiniz.</p>
            <Link 
              to="/products" 
              ...
              <div className="p-6">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
                  <div className="mb-2 sm:mb-0">
                    <h2 className="text-lg font-semibold">Sipariş #{order.id}</h2>
                ...
                <div className="border-t border-gray-200 pt-4 mt-4 flex justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-900">{order.total.subtotal.toFixed(2)} TL</p>
                    <p className="text-sm text-gray-900">{order.total.shippingFee.toFixed(2)} TL</p>
                    <p className="text-lg font-medium text-amber-600 mt-2">
